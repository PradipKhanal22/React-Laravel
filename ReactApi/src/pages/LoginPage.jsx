                ...
                <div className="w-full max-w-2xl"> {/* Wider form */}
                    ...
                    <div className="bg-white/95 backdrop-blur-2xl rounded-3xl shadow-2xl p-10 md:p-12 border border-white/30">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
                            {/* Google Login */}
                            <button className="w-full py-2 border-2 border-gray-300 rounded-2xl font-semibold text-gray-800 hover:bg-gray-50 transition flex items-center justify-center gap-3 text-lg">
