  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-2xl"> {/* Wider form */}
          {/* Glassmorphic Wide Login Card */}
          <div className="bg-white/95 backdrop-blur-2xl rounded-3xl shadow-2xl p-10 md:p-12 border border-white/30">
            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <Link
                  to="/forgot-password"
                  className="text-base font-semibold text-purple-600 hover:text-purple-700 transition"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="flex items-center my-3">
              ...
              <span className="px-6 text-gray-500 font-medium">or continue with</span>
              <div className="flex-1 border-t border-gray-300"></div>
            </div>

            {/* Google Login */}
            <button className="w-full py-3 border-2 border-gray-300 rounded-2xl font-semibold text-gray-800 hover:bg-gray-50 transition flex items-center justify-center gap-4 text-lg">
            ...
            <p className="text-center mt-4 text-gray-700 text-lg">
              ...
              <Link to="/register" className="font-bold text-purple-600 hover:text-purple-700 transition">
                Sign up now
              </Link>
            </p>
          </div>
